...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\laragon\www\ecopantau\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.D:\\laragon\\www\\ecopantau\\public\\storage','logging.default',
...
'password.request','password.email','password.reset','password.update','password.confirm','home','admin.dashboard','admin.reports.index','admin.reports.show',
'admin.reports.edit','admin.reports.update','admin.reports.update-status','admin.users.index','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','user.dashboard','user.reports.index',
'user.reports.create','user.reports.store','user.reports.show','user.reports.my','user.profile.edit',
'user.profile.update',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.reports.index','admin.reports.show','admin.users.edit','admin.users.index',
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','home','layouts.app','user.dashboard','user.profile.edit',
'user.reports.create','user.reports.my_reports','user.reports.show','welcome','laravel-exceptions-renderer::components.card',
